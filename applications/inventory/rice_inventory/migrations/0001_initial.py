    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rice_id', models.CharField(default='59943587', editable=False, max_length=255, verbose_name='ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rice_id', models.CharField(default='24802561', editable=False, max_length=255, verbose_name='ID')),
                ('total_avail_volume', models.IntegerField(verbose_name='Total Available Volume')),
                ...
                ('inventory_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='mongo_inventory', to='rice_inventory.riceinventory')),
            ],
            options={
